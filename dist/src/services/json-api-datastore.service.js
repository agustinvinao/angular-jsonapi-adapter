...
var JsonApiDatastore = /** @class */ (function () {
    ...
    function (modelType, params, headers) {
        var _this = this;
    ...
    JsonApiDatastore.prototype.saveRecord = function (attributesMetadata, model, params, headers) {
        ...
        return httpCall
            ...
            _this.extractRecordData(res, modelType, model),
                _this.resetMetadataAttributes(res, attributesMetadata, modelType),
                _this.updateRelationships(res, relationships);
