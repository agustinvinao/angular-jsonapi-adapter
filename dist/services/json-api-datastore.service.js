...
var JsonApiDatastore = /** @class */ (function () {
    ...
    JsonApiDatastore.prototype.findManyRelated = function (modelType, id, relatedModelType, params, headers) {
        ...
        return this.httpClient
            .get(url, { headers: customHeadhers })
            .pipe(operators_1.map(function (res) { return _this.extractQueryData(res, modelType, true, relatedModelType, false); }), operators_1.catchError(function (res) { return _this.handleError(res); }));
    };
    JsonApiDatastore.prototype.findOneRelated = function (modelType, id, relatedModelType, params, headers) {
        ...
        return this.httpClient
            .get(url, { headers: customHeadhers })
            .pipe(operators_1.map(function (res) { return _this.extractQueryData(res, modelType, true, relatedModelType, true); }), operators_1.catchError(function (res) { return _this.handleError(res); }));
    };
    ...
    JsonApiDatastore.prototype.saveRecord = function (attributesMetadata, model, params, headers) {
        ...
        return httpCall
            .pipe(operators_1.map(function (res) { return _this.extractRecordData(res, modelType, model); }), operators_1.map(function (res) { return _this.resetMetadataAttributes(res, attributesMetadata, modelType); }), operators_1.map(function (res) { return _this.updateRelationships(res, relationships); }), operators_1.catchError(function (res) { return _this.handleError(res); }));
    };
